...
namespace CursesSharp.Internal
{
    internal static partial class CursesMethods
    {
        ...
        internal static int mvwinwchnstr(IntPtr win, int y, int x, CChar[] ch, int n)
        {
            int ret = wrap_mvwin_wchnstr(win, y, x, ch, n);
            InternalException.Verify(ret, "mvwin_wchnstr");
            return ret;
        }
        ...
        [DllImport("CursesWrapper")]
        private static extern int wrap_mvwin_wchnstr(IntPtr win, int y, int x, CChar[] ch, int n);
    }
}
