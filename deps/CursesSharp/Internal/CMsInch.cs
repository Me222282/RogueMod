...
namespace CursesSharp.Internal
{
    internal static partial class CursesMethods
    {
        ...
        internal static CChar mvwinwch(IntPtr win, int y, int x)
        {
            CChar ret = wrap_mvwin_wch(win, y, x);
            return ret;
        }
        ...
        [DllImport("CursesWrapper")]
        internal static extern CChar wrap_mvwin_wch(IntPtr win, int y, int x);
    }
}
