...
namespace CursesSharp
{
    ...
    public abstract class WindowBase: IDisposable
    {
        ...
        public void AddW(char ch)
        {
            CursesMethods.waddwch(this.winptr, (ushort)ch);
        }
        ...
        public void AddW(int y, int x, CChar[] chs, int n)
        {
            CursesMethods.mvwaddwchnstr(this.winptr, y, x, chs, n);
        }
        ...
        public unsafe char ReadOutputCharW(int y, int x)
        {
        ...
        public CChar[] ReadOutputCharsW(int y, int x, int n)
        {
            CChar[] buf = new CChar[n + 1];
            CursesMethods.mvwinwchnstr(this.winptr, y, x, buf, n);
            return buf;
        }
